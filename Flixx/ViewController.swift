...
//  Flixx
//
//  Created by Hamida Khatri on 9/25/20.
//
    ...
    override func viewDidLoad() {
        ...
        let task = session.dataTask(with: request) { (data, response, error) in
           ...
           if let error = error {
            ...
            self.movies = dataDictionary["results"] as! [[String:Any]]// download the info from the APi and store it in accessing key "results" inside of the dataDictionary
